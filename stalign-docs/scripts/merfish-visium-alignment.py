...
# coding: utf-8
"""
Aligning single-cell resolution spatial transcriptomics data to H&E staining image
from Visium using STalign (original implementation)
"""
...
print(f"Running STalign LDDMM on {device}...")
...
output_csv = OUTPUT_DIR / 'stalign_merfish_visium_results.csv.gz'
